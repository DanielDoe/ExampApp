 ...
 * @Date: 2017-11-09 12:27:25 
 * @Last Modified by: Kenneth Kwakye-Gyamfi
 * @Last Modified time: 2017-12-27 13:59:06
 * 
...
if (!(fs.existsSync(dll) && fs.existsSync(manifest))) {
    ...
    console.log(chalk.yellow.bold(
        'DLL Files are missing. Re-building them using `npm run build:dll`'
    ));
...
export default merge.smart(baseConfig, {
    ...
    output: { publicPath: `http://localhost:${port}/build/` },
